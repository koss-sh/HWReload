...
public class HogwartsBook {
    ...
    static void compare2Gryffindors(Gryffindor s1, Gryffindor s2) {
        ...
        if (sum1 > sum2) {
            System.out.println(s1.getName() + " is better gryffindor's than " + s2.getName());
        } else {
            System.out.println(s2.getName() + " is better gryffindor's than " + s1.getName());
        }
    }
    static void compare2Hufflepuffs(Hufflepuff s1, Hufflepuff s2) {
        ...
        if (sum1 > sum2) {
            System.out.println(s1.getName() + " is better hufflepuff's than " + s2.getName());
        } else {
            System.out.println(s2.getName() + " is better hufflepuff's than " + s1.getName());
        }
    }
    static void compare2Ravenclaws(Ravenclaw s1, Ravenclaw s2) {
        ...
        int sum2 = s2.getCreativity() + s2.getIntellect() + s2.getWittiness()
                + s2.getWisdom();
        if (sum1 > sum2) {
            System.out.println(s1.getName() + " is better ravenclaw's  than " + s2.getName());
        } else {
            System.out.println(s2.getName() + " is better ravenclaw's  than " + s1.getName());
        }
    }
    static void compare2Slytherins(Slytherin s1, Slytherin s2) {
        ...
        if (sum1 > sum2) {
            System.out.println(s1.getName() + " is better slytherin's  than " + s2.getName());
        } else {
            System.out.println(s2.getName() + " is better slytherin's  than " + s1.getName());
        }
    }
